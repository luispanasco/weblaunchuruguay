...
export function generateStaticParams() {
    return products.filter(p => p.category === 'elevadores').map((product) => ({
        id: product.id,
    }));
}

export default function ElevadoraDetailPage({ params }: { params: { id: string } }) {
                        ...
                        <div>
                            <div className="mb-8">
                                ...
                                <p className="text-xl text-muted-foreground">
                                    {product.features[0]} {/* Use first feature as subtitle/short desc */}
                                </p>
                            </div>
